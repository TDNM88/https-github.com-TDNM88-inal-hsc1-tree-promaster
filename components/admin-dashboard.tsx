  ...
  const [customers, setCustomers] = useState([
    {
      ...
      fullName: "Amen 123",
      role: "user",
      balance: { available: Math.floor(Math.random() * 5000000), frozen: Math.floor(Math.random() * 500000) },
      loginInfo: "192.168.1.1",
      verification: { cccdFront: false, cccdBack: false, verified: Math.random() > 0.5 },
    ...
    },
    {
      ...
      status: { active: true, betLocked: false, withdrawLocked: false },
      bank: { name: "Vietcombank", accountNumber: "1234567890", accountHolder: "Admin User" },
      isActive: true,
      isVerified: true,
      isBetLocked: false,
      isWithdrawLocked: false,
          ...
          prev.map((customer) =>
            customer.id === editingCustomer.id
              ? {
                  ...
                  balance: { ...customer.balance, available: editForm.balance },
                      ...
                      <div className="text-sm space-y-1">
                        <div>
                          ...
                          <span className="font-semibold text-green-600">
                            {customer.balance.available.toLocaleString()}
                          </span>
                        </div>
                        <div>
                          Số dư đông băng:{" "}
                          <span className="font-semibold text-orange-600">
                            {customer.balance.frozen.toLocaleString()}
                          </span>
                        </div>
                      </div>
                    </TableCell>
